// Founder Handover Component - E-Learning
'use client'
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      ...
      <div className="p-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  E-learning platform deliverables
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-2 text-sm text-slate-700 bg-slate-50 p-2 rounded"
                    >
                      <svg
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      role: 'Student',
                      action: 'Watch video lessons',
                      benefit: 'learn new skills',
                    },
                    {
                      role: 'Instructor',
                      action: 'Create modules',
                      benefit: 'organize content',
                    },
                    {
                      role: 'Admin',
                      action: 'Track engagement',
                      benefit: 'improve courses',
                    },
                  ].map((story, i) => (
                    <div
                      key={i}
                      className="text-sm p-3 bg-blue-50 rounded-lg border border-blue-100"
                    >
        ...
        {/* Technical tab adapted for Video/Storage */}
        {activeTab === 'technical' && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">Video infrastructure details</p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  title: 'MVP Launch',
                  date: 'Now',
                  desc: 'Core video player, Course creation, Progress',
                },
                {
                  phase: 'Phase 2',
                  title: 'Interactive Quizzes',
                  date: '+2 Months',
                  desc: 'Advanced assessment types & grading',
                },
                {
                  phase: 'Phase 3',
                  title: 'Community Features',
                  date: '+4 Months',
                  desc: 'Student forums, Comments, Peer review',
                },
              ].map((item, i) => (
